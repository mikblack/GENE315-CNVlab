...
Aligned sequence data from the 1000 Genomes Project was obtained from their ftp download site:

ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/

For this lab we are using a relatively small subset of the full data (310 samples) out of 2535, from three of the 26 populations included in the study.
