...
The data for this module are available from Blackboard. 

Instructions for downloading the required files are contained in the 
`GENE315-CNV_lab-week1.pdf` document in the "Module 2: Copy Number Variation" folder 
(under "Labs" in the "Course Documents" section).
...
Once you have access to RStudio, you can get started with the work for the lab by downloading the file `GENE315-CNV_lab-week1.pdf` from Blackboard, and watching the video walkthrough of the lab (access this from the "Echo360 Recordings" button in the "Labs" folder under "Course Documents")
