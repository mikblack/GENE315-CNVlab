...
The file ```CNcalls.csv``` contains genotype data for SNPs near the IRGM and FCGR3B genes.  For IRGM the SNP ID is ```rs13361189```, and for FCGR3B the SNP ID is ```rs117435514```.  These data are stored in the files ```IRGM_rs13361189.csv``` and ```FCGR_rs117435514.csv```.
